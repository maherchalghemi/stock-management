    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.PhotoUploadSuccess ? "Votre photo a été téléchargé."
                : message == ManageMessageId.FileExtensionError ? "Les formats pris en charge sont jpg, png et gif."
                : "";
        ...
        public async Task<ActionResult> UploadPhoto(HttpPostedFileBase file)
        {
            if (file != null && file.ContentLength > 0)
            {
                ...
                {
                    var filePath = HostingEnvironment.MapPath("~/Content/images/profil/") + fnm;
                    var directory = new DirectoryInfo(HostingEnvironment.MapPath("~/Content/images/profil/"));
